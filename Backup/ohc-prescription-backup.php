...
<link rel="stylesheet" href="<?php echo $sitepath; ?>css/plugins/datepicker/datepicker.css"><!-- Datepicker -->

<!-- Datepicker -->
<script src="<?php echo $sitepath; ?>js/plugins/datepicker/bootstrap-datepicker.js"></script>
...
<div class="container-fluid" id="content">
    ...
    if ($tbs_role == "4" && !empty($_SESSION['ohc_doc'])) {
        ...
        $prescription = $prescriptionDetail->listShowDetails($tablename, array('id' => $id));
        if ($prescription != 0) {
    ...
    ?>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                <? if (isset($_REQUEST['doid']) && !empty($_REQUEST['doid'])) { ?>
                    getDoctorNew(<? echo $_REQUEST['doid'] ?>);
                <? } ?>
            });
                ...
                <div>
                    <div class="Top-Strip">
                        <div class="col-xl-4 col-lg-4 col-md-4 float-left px-0">
                            <h5 style="font-weight:bold;color:#<? echo $_SESSION['tclr'] ?>;">Add Prescription</h5>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 float-left" style="padding: 5px;"><b><? echo $UserDetailfirst_name . " " . $UserDetaillast_name . "  " . $DoctorQualification; ?></b></div>
                    ...
                    <div class="box box-bordered box-color" style="margin-top: 10px;">
                        <div id="drugDescriptions"><!--open div for the drugDescriptions-->
                            ...
                            if ($tbs_role == "4") { ?>
                                ...
                                <input type="hidden" name="docname" value="<? echo $tbs_userid ?>" />
                                <input type="hidden" name="ohcs" value='1' />
                                <input type="hidden" name="fav_pharmacy" value="<? echo $_SESSION['ohc_loca']; ?>" />
                                <input type="hidden" name="corp_id" value='<? echo $_SESSION['ohc_loca']; ?>' />
                                <div class="content-table float-left pt-0">
                                    <input type="hidden" name="case_id" value="<? echo $_GET['case']; ?>" />
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 float-left p-2">
                                        ...
                                        <input type="text" class="input-large icon_90" name="newtemplate" onkeypress="return samblockSpecialChar(event)" id="newtemplate" placeholder="New Template Name">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 float-left p-2">
                                        ...
                                        if (isset($_GET['case'])) {
                                            ...
                                            } else if ($corporatecomponentdetails[0]["report_time"] == '1') {
                                                $created_case = date("d/m/Y", strtotime($UserDeta[0]['created_case']));
                                            } else if ($corporatecomponentdetails[0]["report_time"] == '2') {
                                        ...
                                        <input type="text" name="fromdate" id="fromdate" readonly="readonly" class="datepick datepickohc" style="width:90px;" value="<?php echo isset($_GET['case']) ? $created_case : date("d/m/Y"); ?>">
                                    </div>
                                </div>
                                <div class=" float-left pt-0" style="border-top:1px solid #999; border-bottom:1px solid #999; width:100%; background-color: #eee;">
                                    ...
                                    <div class="col-xl-1 col-lg-1 col-md-1 float-left p-2">
                                        <label for="questions" class="control-label titclr" style="font-size:14px;font-weight:bold;color:#<? echo $_SESSION['tclr'] ?>;"> User Details</label>
                                    </div>
							...
							<b style="text-transform: capitalize; color:#<? echo $_SESSION[tclr] ?>; float:right; margin-top: 10px;">' . $gender . '/' . $age . ' </b>';  ?>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 float-left p-1" style="border-right:1px dashed #999;">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 float-left p-0">
                                                <div class="col-xl-5 col-lg-5 col-md-5 float-left p-0" style="text-align:right">Drug Allergy: &nbsp;</div>
                                                <div class="col-xl-7 col-lg-7 col-md-7 float-left p-0"><b>
                                                        <?
                                                        ...
                                                        foreach ($allergy_details as $allergy) {
                                                            if (!empty($allergy)) {
                                                                $all = $aller->listDirectQuery(" select id,drug_name  from master_drugs where id=" . $allergy . " ");
                                                            }
                                                            $aller_arr[] = $all[0]['drug_name'];
                                                        }
                                        ...
                                        <?php }
                                            if ($UserDeta[0]['related'] == '1' || $UserDeta[0]['related'] == '3') { ?>
                                        </div>
                                    ...
                                    <? if ($UserDeta[0]['related'] == '2' || $UserDeta[0]['related'] == '4' || $UserDeta[0]['related'] == '5') { ?>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-4 float-left p-1" style="border-left:1px dashed #999;">
                                        <div class="col-xl-12 col-lg-12 col-md-12 float-left p-0">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 float-left p-0">
                                            ...
                                            <div class="col-xl-7 col-lg-7 col-md-7 float-left p-0"><b>
                                                    ...
                                                    $condit = explode(",", $consels[0]['conditions']);
                                                    ?>
                                ...
                                <div class="jspatientc" style="<?php if (isset($_GET['case']) || @$suserid != "") { ?>display:none;<?php } ?>">
                                    ...
                                    <div id="get_age_gender"><b style="text-transform: capitalize; color:#<? echo $_SESSION[tclr] ?>; float:right; margin-top: 10px; padding-right: 25px;"><?php echo $age . "/" . $gender; ?></b></div>
                                </div>
                ...
                <div class="box box-bordered box-color" style="float:left; margin-top:10px;">
                    ...
                    <div class=" nopadding">
                        <div class="tab-pane active content-table py-0 float-left" id="user">
                            <div class="prescription-tr-table" style="width:100%; padding: 5px 0; float:left; border-bottom: 1px #333 solid; font-weight:bold;color:#<? echo $_SESSION['tclr'] ?>;">
                                    ...
                                    <tr id="0">
                                        <td data-content="Drug Name" style="padding: 5px 0; width: 22%; ">
                                            ...
                                            <div class="drugname " title="drugname">
                                                ...
                                                <select class="hiddendrugname" style="height:25px;width:85%;" name="hiddendrugname[]" id="hiddendrugname" onChange="getdrugdetails(this);drugname_validation();">

                                                    <option value="" selected="selected">Select Drug</option>
                                                    <?php

                                                    $GtTemplate = new ManageUsers();
                                                    $ohphrmcy_id_sanitized = intval($ohphrmcy_id[0]['id']);
                                                    $searchValue_sanitized = $searchValue;

                                                    $query = "SELECT 
            (SUM(pd.quantity) - st.soldcount) AS balancecount,
            st.*
          FROM 
            (
              SELECT 
                psd.*, 
                mp.reminder_issue, 
                SUM(DISTINCT psd.quantity), 
                SUM(pssd.qty) AS soldcount, 
                (SUM(DISTINCT psd.quantity) - IFNULL(SUM(pssd.qty), 0)) AS balance_quantity 
              FROM 
                `pharmacy_stock_detail` psd 
              ...
              WHERE 
                psd.isactive = '1' 
                AND psd.phar_ids IN ($ohphrmcy_id_sanitized) 
                AND psd.ohc = '1' 
                AND psd.drug_name LIKE '$searchValue_sanitized%' 
                AND psd.drug_expiry_date > '$nearexpiry' 
              GROUP BY 
                psd.drug_name  
              ORDER BY 
                psd.drug_expiry_date ASC 
              LIMIT 5
            ) AS st 
          INNER JOIN pharmacy_stock_detail pd ON st.drug_name = pd.drug_name 
          WHERE 
            pd.drug_expiry_date > '$nearexpiry' 
            AND pd.isactive = '1' 
            AND pd.phar_ids IN ($ohphrmcy_id_sanitized) 
            AND pd.ohc = '1' 
          GROUP BY 
            pd.drug_name";

                                                    $GtTemplates = $GtTemplate->listDirectQuery($query);
                                                    $drugSearchObj = new ManageUsers();

                                                    $fliter3 = $drugSearchObj->listDirectQuery("select reminder_issue from master_corporate where id='" . $_SESSION['currentlocation_id'] . "' ");
                                                    $tday = date("Y-m-d");
                                                    $remindissue = "+" . $fliter3[0]['reminder_issue'] . "days";
                                                    $nearexpiry = date("Y-m-d", strtotime($tday . " " . $remindissue));
                                                    $ohphrmcy_id = $drugSearchObj->listDirectQuery("SELECT group_concat(id) as id FROM `ohc_pharmay` where corp_id=" . $_SESSION['parent_id'] . " and
                                                    location_id='" . $_SESSION['ohc_loca'] . "' ");
                                                    $today = date('Y-m-d');
                                                    //echo "select (sum(pd.quantity)-st.soldcount) as balancecount,st.* from (SELECT psd.*,mp.reminder_issue,sum(distinct(psd.quantity)),SUM(pssd.qty) as soldcount,(sum(distinct(psd.quantity))-IFNULL(SUM(pssd.qty),0)) as balance_quantity FROM `pharmacy_stock_detail` psd LEFT OUTER JOIN `pharmacy_sold_stock_detail` pssd ON pssd.r_stock_id = psd.id LEFT OUTER JOIN `master_corporate` mp ON mp.id = pssd.r_pharmacy_id WHERE psd.isactive='1' and psd.phar_ids in (".$ohphrmcy_id[0]['id'].") and psd.ohc='1' AND psd.drug_name like '".$searchValue."%' and psd.drug_expiry_date > '$nearexpiry' GROUP BY psd.drug_name order by psd.drug_expiry_date ASC LIMIT 5) as st inner join pharmacy_stock_detail pd on st.drug_name = pd.drug_name where pd.drug_expiry_date > '$nearexpiry' and pd.isactive='1' and pd.phar_ids in (".$ohphrmcy_id[0]['id'].") and pd.ohc='1' GROUP by pd.drug_name";
                                                    $drugSearchs = $drugSearchObj->listDirectQuery("select (sum(pd.quantity)-st.soldcount) as balancecount,st.* from (SELECT psd.*,mp.reminder_issue,sum(distinct(psd.quantity)),SUM(pssd.qty) as soldcount,(sum(distinct(psd.quantity))-IFNULL(SUM(pssd.qty),0)) as balance_quantity FROM `pharmacy_stock_detail` psd LEFT OUTER JOIN `pharmacy_sold_stock_detail` pssd ON pssd.r_stock_id = psd.id LEFT OUTER JOIN `master_corporate` mp ON mp.id = pssd.r_pharmacy_id WHERE psd.isactive='1' and psd.phar_ids in (" . $ohphrmcy_id[0]['id'] . ") and psd.ohc='1' and psd.drug_expiry_date > '$nearexpiry' GROUP BY psd.drug_name order by psd.drug_expiry_date ASC LIMIT 5) as st inner join pharmacy_stock_detail pd on st.drug_name = pd.drug_name where pd.drug_expiry_date > '$nearexpiry' and pd.isactive='1' and pd.phar_ids in (" . $ohphrmcy_id[0]['id'] . ") and pd.ohc='1' GROUP by pd.drug_name");
                                                    if ($drugSearchs != 0) {

                                                        foreach ($drugSearchs as $drugSearch) {
                                                            $drugId = $drugSearch['id'];
                                                            $drugName = $drugSearch['drug_name'];
                                                            echo '<option value="' . $drugName . '--' . $drugId . '">' . $drugSearch['drug_name'] . '</option>';
                                                        }
                                                    }
                                                    ?>
                                        ...
                                        <td style="padding: 5px 0; width:10%; text-align:center;" class="avalcount">--</td>


                                        <td data-content="Days" style="padding: 4px 0; width:5%;"><input type="text" maxlength="3" name="duration[]" id="duration" class="duration tblduration input-minix" placeholder="Days" onKeyPress="return ValidNumber(event)" value="" style="width:65px;" /></td>
				...
				">
                                        ...
                                        <td data-content="Drug Type" style="padding: 5px 0; width:12%;" class="dtype">

                                        </td>


                                        <td data-content="AF/BF" style="padding: 5px 0; width:14%;"><select name="drugintakecondition[]" id="drugintakecondition" class="select drugintakecondition py-2">
                                        ...
                                        <td class="add">
                                            <div style="position:absolute; margin-top:-8px; cursor:pointer;" class="margin-t-8 cross addjs" id="cl" onClick="addRow1('dataTable1')"><i class="glyphicon-circle_plus"></i></div>
                                        </td>
                            ...
                            <!-- Other Prescription -->
                            <div style="width:100%; padding: 5px 0; float:left; border-bottom: 1px #333 solid; font-weight:bold;color:#<? echo $_SESSION['tclr'] ?>;">
                                    ...
                                    <tr id="0">
                                        <td data-content="Drug Name" style="width: 32%; ">
                                            ...
                                            <div class="drugname " title="drugname">
                                                ...
                                                echo '<input type="text"  name="hiddendrugname[]" onkeypress="return samblockSpecialChar(event)" placeholder="Outside Drug Name"   class="input-large outside-drug-name"  style="width:95%;"/>';
                                                ?>
                                            </div>
                                        </td>
				...
				">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-4 float-left p-2">
                                    ...
                                    <select name="fav_pharmacy" id="fav_pharmacy" class="select2-me input-large floatleft" style="">
                                        <option value="">Select your favorite Pharmacy<?php if ($tbs_role == "1" || $tbs_role == "2") { ?>
                                            <optgroup label="Favorite - <?php if ($tbs_role == "2") { ?>Doctor<?php } else { ?>User<?php } ?>">
                                                <?php
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 p-2 float-left">
                            <div class="col-xl-6 col-lg-6 col-md-6 float-left">
                                <textarea class='dnotes input-large' rows="2" name="dnotes" onkeypress="return samblockSpecialChar(event)" id="dnotes" style="width:95%; height:70px;" placeholder="Notes to the patient"><?php if (isset($_GET['case'])) {
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 float-left">
                                ...
                                <textarea class='mnotes input-large' rows="2" name="mnotes" id="mnotes" onkeypress="return samblockSpecialChar(event)" style="width:95%; height:70px;" placeholder="<?php if (isset($_GET['case'])) {
                                                                                                                                                                                                        echo "Doctor Notes";
                                                                                                                                                                                                    } else {
                                                                                                                                                                                                        echo "Doctor Notes";
            ...
            for (var itotcount = 0; itotcount < totalcount; itotcount++) {
                ...
                if (drugQty != "") {
                    if ((mrngQty == "" || mrngQty == 0) && (earlyMrngQty == "" || earlyMrngQty == 0) && (lateMrngQty == "" || lateMrngQty == 0) && (aftQty == "" || aftQty == 0) && (lateAftQty == "" || lateAftQty == 0) && (eveQty == "" || eveQty == 0) && (nytQty == "" || nytQty == 0) && (lateNytQty == "" || lateNytQty == 0)) {
                        alert("Atleast one Duration should be filled");
