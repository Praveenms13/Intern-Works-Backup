...
alert("Please Select File");
	...
	if(file_data.name.toLowerCase().lastIndexOf(".csv")==-1){
		...
		if (form_data) {form_data.append("file", file_data);form_data.append("action","ohcuploaded");form_data.append("phrss",phr);}
		$.ajax({
...
<input type="text" id="search" name="search" value="" placeholder="Drug Name" onKeyUp="getListofDatas('search',this,'','','')" />	</div>
<div class="w-50 my-3 float-left">
<input type="text" id="manuf" name="search" value="" placeholder="Manufacturer" onKeyUp="getListofDatas('search',this,'','','')" /></div>
</div>
...
<div class="col-xl-4 col-lg-4 col-md-4 px-0 float-left ml-2">
					<input type="file" name="files"  id="upfile" /></div>
