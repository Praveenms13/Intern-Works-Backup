                                    ...
                                    <tr id="0">
                                        <td data-content="Drug Name" style="padding: 5px 0; width: 22%;">
                                            ...
                                            <div class="drugname" title="drugname">
                                                ...
                                                <select class="hiddendrugname" style="height:25px;width:85%;" name="hiddendrugname[]" id="hiddendrugname" onfocus="changeDefaultText();" onChange="getdrugdetails(this);drugname_validation();get_allergic_ingredient_alert(this);displayTotalAvailability(this);">
                                                    <option value="" selected="selected">Search</option>
                                                    <?php
                                                    foreach ($consolidatedDrugs as $drugName => $drugInfo) {
                                                        $totalStrength = $drugInfo['totalStrength'];
                                                        $totalAvailability = $drugInfo['totalAvailability'];
                                                        $drugTemplateId = $drugInfo['drug_template_id'];
                                                        echo '<option value="' . $drugName . '--' . $drugInfo['id'] . '--' . $totalStrength . '--' . $totalAvailability . '--' . $drugTemplateId . '">' . $drugName . ' - ' . $drugInfo['type'] . ' - ' . $totalStrength . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <td data-content="Remarks" style="padding: 5px 0; width: 12%;"><input type="text" name="remarks[]" id="remarks" placeholder="Remarks" class="remarks input-medium" style="width:90%;height:28px!important;" /></td>
                                        <td class="add">
                                ...
                                <script>
                                    ...
                                    function addRow1(tableID) {
                                        ...
                                        for (var i = 0; i < colCount; i++) {
                                            ...
                                            var inputs = newcell.querySelectorAll('input, select, textarea');
                                            ...
                                            if (newcell.querySelector('.strengthDisplay')) {
                                                newcell.querySelector('.strengthDisplay').innerText = '';
                                            }
                                        }
...
<div class="prescription-tr-table" style="width:100%; padding: 5px 0; border-bottom: 1px #333 solid;float:left;">
	...
	<input type="hidden" name="rowid[]" id="rowid2" value="0" />
	 <div class="drugname " title="drugname">
			...
			<?php echo '<input type="text"  name="hiddendrugname[]" placeholder="Outside Drug Name"   class="input-large outside-drug-name"  style="width:95%;"/>'; ?> 
			   </div>  
	</td>
...
<td data-content="Days" style="width:5%;"><input type="text" maxlength="3" name="duration[]" id="duration" class="duration tblduration input-minix" placeholder="Days"  onKeyPress="return ValidNumber(event)" value="" style="width:65px;"  /></td>
		   <td class="timdur2" style="width:20%; padding: 3px 1px;">
			...
			<div data-content="Morning (AM)"><input type="text" maxlength="2" name="morning[]" id="m0" class="morning input-minix" placeholder="0" onkeyup="" onkeypress="return ValidNumber(event)" value="" style="float:left;text-align:center;width:33px;margin-right:8px;padding:0px;
				"></div><div data-content="Noon"><input type="text" maxlength="2" name="afternoon[]" id="a0" class="afternoon input-minix" placeholder="0" onkeyup="" onkeypress="return ValidNumber(event)" value="" style="float:left;text-align:center;width:33px;margin-right:8px;padding:0px;
				"></div><div data-content="Evening"><input type="text" maxlength="2" name="evening[]" id="e0" class="evening input-minix" placeholder="0" onkeyup="" onkeypress="return ValidNumber(event)" value="" style="float:left;text-align:center;width:33px;margin-right:8px;padding:0px;
				"></div><div data-content="Night (PM)"><input type="text" maxlength="2" name="night[]" id="n0" class="night input-minix" placeholder="0" onkeyup="" onkeypress="return ValidNumber(event)" value="" style="float:left;text-align:center;width:33px;margin-right:8px;padding:0px;
				">			
			</td>
		  ...
		  <select name="drugtype[]" id="drugtype" class="select tbldrugtype " style="width:auto;" >   
...
<td data-content="AF/BF" style="width:14%;"><select name="drugintakecondition[]" id="drugintakecondition" class="select drugintakecondition py-2" style="width:auto;">
  ...
  <td class="add"><div style="position:absolute; margin-top:-8px; cursor:pointer;" class="margin-t-8 cross addjs" id="cl" onClick="addRow2('dataTable2')"><i class="glyphicon-circle_plus"></i></div></td>
