...
<div class="container-fluid" id="content">
    ...
    <div id="main">
        ...
        <div class="content-table float-left" style="">
            <div class="col-xl-4 col-lg-4 col-md-4 float-left p-2">
                <input type="text" id="drug_name" class="icon_90" name="search" value="" placeholder="Drug Name" onKeyUp="search()" />
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 float-left p-2">
                <input type="text" id="manufacture" class="icon_90" name="search" value="" placeholder="Manufacturer" onKeyUp="search()" />
            </div>
        </div>
        ...
        <div class="float-left" style=" color:#199BBF; font-size: 16px; padding: 0 !important;">

            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 float-left p-2">
                <b>Export Template</b> <img src="<? echo $sitepath ?>/img/export-to-csv.png" class="export" onclick="export_template()" alt="Export" title="Export" />
            </div>

            <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 float-right p-2">
                <a href="add-drug-template.php" class="btn btn-sm btn-primary">Add to Drug Template</a>
            </div>
                ...
                <table width="100%" cellpadding="0" cellspacing="2" border="1" align="center" class="display nowrap tableborder table  table-striped " id="result" style="font-size:14px">
                    <thead>
                        <tr style="color:white;background-color:#<? echo $_SESSION['tclr'] ?>;">
                            <th style="text-align:left;width:15%;">Drug Name</th>
                            <th style="text-align:left;width:8%;">Drug Type</th>
                            <th style="text-align:left;">Manufacturer</th>
                            <th style="text-align:left;">HSN Code</th>
                            <th style="text-align:left;">Ingredient</th>
                            <th style="text-align:left;">Schedule</th>
                            <th style="text-align:left;width:5%;">Strength</th>
                            <th style="text-align:left;width:8%;">Restock Count</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="color:black;">
                                ...
                                <td style="text-align:left;"><?= $l['drug_strength'] ?></td>
